# Feliz.Plotly - Ternary Contour Plots

Taken from [Plotly - Ternary Contour Plots](https://plot.ly/javascript/ternary-contour/)

```fsharp:plotly-chart-ternarycontour-filled
